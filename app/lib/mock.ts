...
export const FAKE_LATEST_ARTICLES: Article[] = [
  ...
  },
  {
    ...
    image_url: 'https://1401700980.rsc.cdn77.org/data/images/full/116083/sony-digital-paper-dpt-cp1.jpg',
    source_id: 'itechpost',
  ...
  },
  {
    ...
    title: 'Fresno Pacific University eliminating 16 programs, cutting 11 faculty',
  ...
  business: [
    {
      ...
      content:
        'In this article, we delve into the intricacies of the business world, exploring the dynamics of finance and the global economy. We discuss the latest trends and provide an in-depth analysis of recent developments',
      pubDate: '2023-11-16 12:00:00',
      image_url: 'https://th.bing.com/th/id/OIP.b9nUSY-JoJTuNKVSEGmH1wHaE8?rs=1&pid=ImgDetMain',
    ...
    },
    {
      ...
      content:
        'In the ever-evolving world of business, the key to success lies in understanding market trends and adapting to them. With the rise of digital technology, businesses are shifting their focus towards online platforms, leveraging data analytics to understand consumer behavior. Sustainability has also emerged as a crucial factor, with companies striving to balance profitability with social responsibility. Amidst these changes, effective leadership remains a constant requirement, guiding businesses through challenges and towards growth. Stay tuned for more insights into the dynamic world of business.',
      pubDate: '2023-11-16 12:30:00',
      image_url:
        'https://www.uksafetystore.com/media/catalog/product/cache/0add91c40202c758a0333fbef9acdf8d/f/i/fic.01.jpg',
    ...
    },
    {
      ...
      content:
        'In the dynamic landscape of business, innovation is the driving force. As companies navigate through the digital revolution, they are leveraging artificial intelligence and machine learning to streamline operations and enhance customer experiences. The rise of remote work culture is reshaping the traditional office environment, promoting flexibility and inclusivity. Meanwhile, businesses are recognizing the importance of sustainability, integrating eco-friendly practices into their strategies. The future of business is here, and it is exciting, challenging, and full of opportunities. Stay tuned for more updates from the business world.',
      pubDate: '2023-11-16 13:00:00',
      image_url: 'https://th.bing.com/th/id/OIP.CO2nkj6Est5du2k66CwDnwHaE8?rs=1&pid=ImgDetMain',
  ...
  environment: [
    {
      ...
      image_url:
        'https://th.bing.com/th/id/R.43a56baab4a5f8957ba980b7931519cf?rik=XAA4KZgCnX57Ew&riu=http%3a%2f%2fwww.topcount.co%2fwp-content%2fuploads%2f2016%2f05%2fEnvironmentBG1.jpg&ehk=FWvBAmEaVC0luvmLJrYpLzfqZogfIuRpAdIC1BXc6as%3d&risl=&pid=ImgRaw&r=0',
      source_id:
        'The environment is at the heart of our existence, its health directly influencing the quality of human life. Climate change, a pressing issue, is causing a shift in weather patterns, leading to extreme weather conditions and rising sea levels. The loss of biodiversity is another major concern, with numerous species facing the threat of extinction. However, there is hope. More people are now recognizing the importance of sustainable living, adopting practices like recycling and conservation. Governments and corporations worldwide are investing in renewable energy, aiming for a greener, cleaner future. Stay tuned for more environmental updates.',
      source_priority: 567,
      country: ['united states of america'],
    ...
    },
    {
      ...
      content:
        'Our environment is a complex web of interdependent systems, each playing a crucial role in maintaining the balance of life on Earth. Deforestation, pollution, and climate change are posing significant threats to this delicate balance. However, the rise of sustainable practices and green technologies offers a beacon of hope. From recycling initiatives to the adoption of renewable energy sources, individuals and organizations are taking steps to reduce their environmental footprint. The journey towards a sustainable future is challenging, but every small step counts. Stay tuned for more updates on environmental conservation.',
      pubDate: '2023-11-16 20:30:00',
      image_url: 'https://th.bing.com/th/id/R.c49a273fd5db1381ff99d22800ced005?rik=e3ZziMB042Hiuw&pid=ImgRaw&r=0',
    ...
    },
    {
      ...
      content:
        'In the heart of the Amazon rainforest, a new species of tree has been discovered. This tree, dubbed the “Green Giant,” has an extraordinary ability to absorb carbon dioxide at a rate three times higher than its counterparts. Scientists believe that this discovery could revolutionize our approach to combating climate change, offering a glimmer of hope in our ongoing battle to preserve our planet’s health and biodiversity. The Green Giant stands as a testament to the untapped potential of our natural world.',
      pubDate: '2023-11-16 21:00:00',
      image_url: 'https://th.bing.com/th/id/OIP.59-xZdr_grgGTBFKSDk5kAHaFB?rs=1&pid=ImgDetMain',
  ...
  technology: [
    {
      ...
      content:
        'In the realm of quantum computing, a breakthrough has been achieved. A team of international scientists has successfully developed a quantum chip that can process information a thousand times faster than traditional silicon-based chips. This leap in technology could revolutionize everything from artificial intelligence to climate modeling, opening up new horizons in our digital world. The era of quantum supremacy is truly upon us.',
      pubDate: '2023-11-16 22:00:00',
      image_url: 'https://wallpaperaccess.com/full/210938.jpg',
    ...
    },
    {
      ...
      image_url: 'https://th.bing.com/th/id/R.3ecac5c8bc7f1ee0ed66f24a97bf678d?rik=Pgp5%2bHthMLbW8Q&pid=ImgRaw&r=0',
    ...
    },
    {
      ...
      image_url: 'https://th.bing.com/th/id/OIP.iORsjqpODDO-0ROAD0GT_QHaE8?rs=1&pid=ImgDetMain',
...
export const FAKE_ALL_ARTICLES = [
  ...FAKE_LATEST_ARTICLES,
  ...Object.values(FAKE_ARTICLE_BY_CATEGORIES).flatMap(articles => articles)
];
